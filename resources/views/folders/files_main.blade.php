...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الملفات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الملفات</span>
						</div>
					</div>
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class="col-sm-6 col-md-4 col-xl-3">
								<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">إضافة ملف</a>
							</div>
							<div class="card-body">
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$folder->section->section_name}}</td>
												<td>{{$folder->folder_desc}}</td>
												
												<td>
													<a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
													   data-id="{{ $folder->id }}" data-folder_name="{{ $folder->folder_name }}" data-toggle="modal"
                                                       data-folder_desc="{{ $folder->folder_desc }}" data-toggle="modal" href="#exampleModal2"
