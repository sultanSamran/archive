<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">برنامج الأرشفةالإلكترونية</li>
					<li class="slide">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/' . $page='icons') }}">
							...
							<span class="side-menu__label">Icons</span><span class="badge badge-danger side-badge">New</span>
						</a>
					</li>
					<li class="slide">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">المعاملات</span><i class="angle fe fe-chevron-down">
								</i>
							</a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/documents') }}">قائمة المعاملات</a></li>
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" >
								...
								<span class="side-menu__label">إعدادات النظام</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/sections') }}">الأقسام</a></li>
							<li><a class="slide-item" href="{{ url('/folders') }}">الملفات</a></li>
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
								<path d="M0 0h24v24H0V0z" fill="none"/><path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3"/>
								...
								<span class="side-menu__label">إعدادات المستخدمين</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
